...
const ToggleStatusModal = ({ isOpen, onClose, onConfirm, guideTitle, currentStatus, loading }) => {
    ...
    <div className="toggle-status-modal-overlay" onClick={onClose}>
      <div className="toggle-status-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-content">
          <p>
            Are you sure you want to <strong>{statusText.toLowerCase()}</strong> the guide <strong>"{guideTitle}"</strong>?
          </p>
